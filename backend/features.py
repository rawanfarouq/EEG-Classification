...
class SignalProcessor:
    ...
    def loadData(fileName):
        if fileName.endswith('edf') or fileName.endswith('edf+'):
            try:
                ...
                SignalProcessor.noiseCancellation(df)
                #return df
            except ImportError:
    ...
    def noiseCancellation(df):
        ...
        '''
        SignalProcessor.extract(filtered_df)
        #return filtered_df
        pass
    ...
    def extract(dfs):
        allfeatures = []
        for df in dfs:
            channelfeatures = SignalProcessor.channelextraction(df)  
            allfeatures.append(channelfeatures)
